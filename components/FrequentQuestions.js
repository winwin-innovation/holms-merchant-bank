export default function FrequentQuestions() {
  return (
    <section class="bg-white dark:bg-gray-900">
      <div class="max-w-screen-xl px-4 mx-auto lg:px-6 pt-20">
        <h2 class="mb-6 text-3xl font-extrabold tracking-tight text-center text-gray-900  lg:text-3xl dark:text-white">
